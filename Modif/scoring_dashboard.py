...
# Créer des noms aléatoire pour la liste de clients
@st.cache
...
with tab_all:
    ...
    if (feat_imp_source == 'LGBM'):
        ...
        st.altair_chart(lgbm_importances_chart(), use_container_width=True)
...
with tab_single:
    ...
    expander.write("The model threshold can be modified in the settings. \
                    ...
                    The best optimized threshold predict a repay failure when probability is lower or equal to 0.55")
